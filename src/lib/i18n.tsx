...
const ES: Record<string, string> = {
  ...
  "Stay": "Quedarme",
  "Blackjack leaderboard": "Tabla de blackjack",
  "Squad chips": "Fichas del squad",
  "Current chips": "Fichas actuales",
  "Last week": "Semana pasada",
  "No chips yet.": "Aún no hay fichas.",
  "No winner yet.": "Aún no hay ganador.",
  ...
  "Squad casino": "Casino del squad",
  "Blackjack table": "Mesa de blackjack",
  "Enter table": "Entrar a la mesa",
  "Place your bet": "Haz tu apuesta",
  "Tap a chip or enter a custom amount.": "Toca una ficha o ingresa una cantidad.",
  "Dealer": "Dealer",
  "Ready": "Listo",
  "Hidden": "Oculto",
  "No active hand": "No hay mano activa",
  "Enter the table to join the next deal.": "Entra a la mesa para unirte a la siguiente mano.",
  "Bet": "Apostar",
  "Waiting for table": "Esperando la mesa",
  "Next hand": "Siguiente mano",
  "Hit": "Pedir",
  "Stand": "Plantarse",
  "Double": "Doblar",
  "Insurance": "Seguro",
  "Rotate your phone": "Gira tu teléfono",
  "Blackjack works better in landscape so cards, chips, and seats have room.": "Blackjack funciona mejor en horizontal para que cartas, fichas y lugares tengan espacio.",
  "Close blackjack": "Cerrar blackjack",
  "Dealer deck": "Baraja del dealer",
  "Custom bet amount": "Apuesta personalizada",
  "Could not open blackjack": "No se pudo abrir blackjack",
  "Blackjack action failed": "La acción de blackjack falló",
  "Could not close blackjack": "No se pudo cerrar blackjack",
...
const REGEX_ES: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
  ...
  [/^(.+) chips available · weekly race closes Sunday 11:59\.$/i, (m) => `${m[1]} fichas disponibles · la carrera semanal cierra domingo 11:59.`],
